...
import WORLD from "../sampleMaps/World.js"

class MapExampleWorld extends React.Component {
  ...
  render() {
    ...
    return(
      <div className="container" style={style.container}>
        <h1 style={style.title}>Populations in the World</h1>
        <br />
        <ComponentContainer optionList={this.state.optionList}
          palette={this.props.palette}>
          <Map data={this.state.optionList[0].initialValue}
            paths={WORLD.svg.g.path} weightKey="population" IDKey="code"
...
export default MapExampleWorld
